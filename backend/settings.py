...
ALLOWED_HOSTS = [
    ...
    '192.168.1.124',
    '192.168.1.137',
    'alphez254.eu.pythonanywhere.com',
]
...
# ============================================================
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': os.environ.get(' dhypckqzq'),
    'API_KEY': os.environ.get('765816332471439'),
    'API_SECRET': os.environ.get('Ay3MuVR3-LUKZcpPtWi3M4YJ_Ys'),
}
